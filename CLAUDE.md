...
The superseded guide is preserved in [docs/history/assistant-guides/CLAUDE.md](docs/history/assistant-guides/CLAUDE.md) for historical reference only. It is not part of routine startup and does not override the current handoff.
