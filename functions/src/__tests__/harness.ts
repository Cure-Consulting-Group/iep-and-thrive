...
process.env.STORAGE_EMULATOR_HOST = TEST_HOSTS.storage;
...
const originalHttpsRequest = httpsTransport.request;
httpsTransport.request = ((options: unknown, callback?: (response: unknown) => void) => {
