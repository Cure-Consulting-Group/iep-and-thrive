      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-text-muted font-body mt-2">
            Sign up to book a discovery call and access your parent portal
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-md border border-border p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="name" className="block text-sm font-semibold text-forest font-body mb-1.5">
                Full Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-semibold text-forest font-body mb-1.5">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
          ...
          <p className="mt-4 text-xs text-text-muted font-body text-center leading-relaxed">
            ...
            <Link href="/terms" className="text-forest hover:underline">Terms of Service</Link>
            {' '}and{' '}
