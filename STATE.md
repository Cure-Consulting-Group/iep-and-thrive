...
- **Sprint plan:** [docs/sprints/sprint-plan.md](docs/sprints/sprint-plan.md) — generated from the ticket dependency graph, not hand-ordered. 76 tickets / 545 points / 23 engineering sprints at 24 pts. Regenerate rather than hand-edit. Sprint 1 is TASK-LP-054, 064, 006 (18 pts); TASK-LP-054 and 014 are the two biggest unlocks (16 and 22 downstream tickets).
